...
static struct resource smdkv210_dm9000_resources[] = {
	[0] = DEFINE_RES_MEM(S5PV210_PA_SROM_BANK1+0x1000, 4),
	[1] = DEFINE_RES_MEM(S5PV210_PA_SROM_BANK1+0x1000 + 4, 4),
...
static void smdkv210_lte480wv_set_power(struct plat_lcd_data *pd,
					unsigned int power)
{
	printk(KERN_WARNING "Function:smdkv210_lte480wv_set_power!\n");

	volatile unsigned int*  display_control = ioremap(0xE0107008,4);
	volatile unsigned int*  gpf0con      = ioremap(0xE0200120, 4);
	volatile unsigned int*  gpf1con      = ioremap(0xE0200140, 4);
	volatile unsigned int*  gpf2con      = ioremap(0xE0200160, 4);
	volatile unsigned int*  gpf3con      = ioremap(0xE0200180, 4);

	volatile unsigned int*  gpd0con      = ioremap(0xE02000A0, 4);
	volatile unsigned int*  gpd0dat      = ioremap(0xE02000A4, 4);
...
static struct s3c_fb_platdata smdkv210_lcd0_pdata __initdata = {
	...
	.vidcon1	= 1<<5 | 1<<6, //VIDCON1_INV_HSYNC | VIDCON1_INV_VSYNC,
...
static struct i2c_board_info smdkv210_i2c_devs2[] __initdata = {
	/* To Be Updated */
	{ I2C_BOARD_INFO("FT5306DE4-ts", 0x38), },     /* Touch Screen FT5306DE4 */
};

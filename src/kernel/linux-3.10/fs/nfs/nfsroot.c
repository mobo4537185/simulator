...
{
	printk(KERN_INFO "Function:root_nfs_data()\n");
	...
	printk(KERN_INFO "root_server_path:%s\tcmdline:%s\n", root_server_path, cmdline);

	if (root_server_path[0] != '\0') {
		printk(KERN_INFO "Root-NFS: DHCPv4 option 17: %s\n",
			root_server_path);
	...
	if (cmdline[0] != '\0') {
		printk(KERN_INFO "Root-NFS: nfsroot=%s\n", cmdline);
...
int __init nfs_root_data(char **root_device, char **root_data)
{
	...
	printk(KERN_INFO "Function: nfs_root_data() \n");
	...
	printk(KERN_INFO "Function: nfs_root_data() 1 \n");
	if (root_nfs_data(nfs_root_parms) < 0)
		return -1;
	printk(KERN_INFO "Function: nfs_root_data() 2 \n");
